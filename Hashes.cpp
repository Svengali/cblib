...
{
	uint32 pc = 0x5768B525;
	uint32 pb = 0x206F85B3;
	hashlittle2(bytes,size,&pc,&pb);

	// he puts the length in so no need for me to do so
	
	uint64 ret = ((uint64)pc<<32) | pb;
